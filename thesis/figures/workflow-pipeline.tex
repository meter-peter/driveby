...
% Lane labels (top)
\node[lane label=red]     at (-3.1,1.9)  {BYOCI};
\node[lane label=violet]  at (-0.8,1.9)  {Hydrator};
\node[lane label=blue]    at (1.3,1.9)   {GitHub};
\node[lane label=cyan]    at (4.1,1.9)   {Ingress};
\node[lane label=teal]    at (5.7,1.9)   {Argo Events};
\node[lane label=orange]  at (9.1,1.9)   {Argo Workflows};
