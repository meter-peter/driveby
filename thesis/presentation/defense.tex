...
\node[bx blue] (a1) at (-5.5,0)   {ArgoCD App};
\node[bx blue] (a2) at (-3.7,0)   {WorkflowTpl};
\node[bx blue] (a3) at (-1.9,0)   {EventSource};
\node[bx blue] (a4) at (-0.1,0)   {Sensor};
\node[bx blue] (a5) at ( 1.7,0)   {Ingress};
\node[bx blue] (a6) at ( 3.5,0)   {RBAC};
\node[bx blue] (a7) at ( 5.3,0)   {Promoter};

\node[bx teal] (b1) at (-5.5,-1.0) {Branches};
\node[bx teal] (b2) at (-3.7,-1.0) {BranchProt};
\node[bx teal] (b3) at (-1.9,-1.0) {RepoFiles};
\node[bx teal] (b4) at (-0.1,-1.0) {Secrets};
\node[bx teal] (b5) at ( 1.7,-1.0) {ScmProvider};
\node[bx teal] (b6) at ( 3.5,-1.0) {GitRepo};
\node[bx teal] (b7) at ( 5.3,-1.0) {SvcAccount};

\node[font=\tiny, text=gray, anchor=west] at (-6.5,-2.0)
