...
Supervisor: Prof.\ Kyriakos Kritikos\\[0.5ex]
{\footnotesize Examination Committee: Prof.\ Spyros Kokolakis (University of the Aegean)\\
Asst.\ Prof.\ Ioannis E. Livieris (University of the Peloponnese)}}
...
\begin{center}
\tiny\itshape
Drift cannot land in production by construction --- the chain blocks any transition that has not passed P006. Closing the verdict tier is future work.
\end{center}
