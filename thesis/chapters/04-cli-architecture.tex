...
DriveBy is implemented as a single Go module (\texttt{github.com/meter-peter/driveby/driveby-cli}). The module is organized into eleven internal packages with a strict, unidirectional dependency flow:
