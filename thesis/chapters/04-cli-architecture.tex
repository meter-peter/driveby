...
Chapter~\ref{ch:kubernetes} describes the Kubernetes infrastructure that hosts DriveBy as a quality gate---Crossplane XRDs, Argo Events, and Argo Workflows---while Chapter~\ref{ch:workflow} describes the GitOps pipelines that trigger validation and promote environments based on its results.
