...
- **Status:** Failed
- **Message:** OpenAPI spec validation failed: Specification structure is valid: invalid components: schema "DSPublicKeyDetail": extra sibling fields: [contentEncoding]
...
```json
{
    ...
    "messages": {
      "Specification structure is valid": "invalid components: schema \"DSPublicKeyDetail\": extra sibling fields: [contentEncoding]"
    }
  }
```
...
- **Status:** Failed
- **Message:** Documentation quality issues found: All request/response bodies have examples: POST /get3dsAvailability: request body, POST /get3dsAvailability: 422 application/json response, POST /get3dsAvailability: 500 application/json response, POST /get3dsAvailability: 401 application/json response, POST /get3dsAvailability: 403 application/json response, POST /getCostEstimate: request body, POST /getCostEstimate: 401 application/json response, POST /getCostEstimate: 403 application/json response, POST /getCostEstimate: 422 application/json response, POST /getCostEstimate: 500 application/json response; All schemas have descriptions: ServiceError, Recurring, ThreeDS2CardRangeDetail, ThreeDSAvailabilityResponse, CostEstimateResponse, Amount, BinDetail, DSPublicKeyDetail, ThreeDSAvailabilityRequest, CardBin, CostEstimateAssumptions, CostEstimateRequest, MerchantDetails
...
```json
{
    ...
    "missing_docs": {
      "All request/response bodies have examples": [
        "POST /get3dsAvailability: request body",
        "POST /get3dsAvailability: 422 application/json response",
        "POST /get3dsAvailability: 500 application/json response",
        "POST /get3dsAvailability: 401 application/json response",
        "POST /get3dsAvailability: 403 application/json response",
        "POST /getCostEstimate: request body",
        "POST /getCostEstimate: 401 application/json response",
        "POST /getCostEstimate: 403 application/json response",
        "POST /getCostEstimate: 422 application/json response",
        "POST /getCostEstimate: 500 application/json response"
      ],
      "All schemas have descriptions": [
        "ServiceError",
        "Recurring",
...
- **Status:** Failed
- **Message:** Request validation issues found: All string fields have length constraints: POST /get3dsAvailability.cardNumber: application/json schema, POST /get3dsAvailability.merchantAccount: application/json schema, POST /get3dsAvailability.recurringDetailReference: application/json schema, POST /get3dsAvailability.shopperReference: application/json schema, POST /get3dsAvailability.brands[]: application/json schema, POST /getCostEstimate.merchantAccount: application/json schema, POST /getCostEstimate.merchantDetails.mcc: application/json schema, POST /getCostEstimate.shopperInteraction: application/json schema, POST /getCostEstimate.recurring.tokenService: application/json schema, POST /getCostEstimate.recurring.contract: application/json schema, POST /getCostEstimate.recurring.recurringDetailName: application/json schema, POST /getCostEstimate.recurring.recurringExpiry: application/json schema, POST /getCostEstimate.recurring.recurringFrequency: application/json schema, POST /getCostEstimate.selectedRecurringDetailReference: application/json schema, POST /getCostEstimate.encryptedCardNumber: application/json schema, POST /getCostEstimate.shopperReference: application/json schema; All numeric fields have min/max values: POST /getCostEstimate.assumptions.installments: application/json schema, POST /getCostEstimate.amount.value: application/json schema
...
```json
{
    ...
    "missing_validation": {
      "All numeric fields have min/max values": [
        "POST /getCostEstimate.assumptions.installments: application/json schema",
        "POST /getCostEstimate.amount.value: application/json schema"
      ],
      "All string fields have length constraints": [
        "POST /get3dsAvailability.cardNumber: application/json schema",
        "POST /get3dsAvailability.merchantAccount: application/json schema",
        "POST /get3dsAvailability.recurringDetailReference: application/json schema",
        "POST /get3dsAvailability.shopperReference: application/json schema",
        "POST /get3dsAvailability.brands[]: application/json schema",
        "POST /getCostEstimate.merchantAccount: application/json schema",
        "POST /getCostEstimate.merchantDetails.mcc: application/json schema",
        "POST /getCostEstimate.shopperInteraction: application/json schema",
        "POST /getCostEstimate.recurring.tokenService: application/json schema",
        "POST /getCostEstimate.recurring.contract: application/json schema",
        "POST /getCostEstimate.recurring.recurringDetailName: application/json schema",
        "POST /getCostEstimate.recurring.recurringExpiry: application/json schema",
        "POST /getCostEstimate.recurring.recurringFrequency: application/json schema",
        "POST /getCostEstimate.selectedRecurringDetailReference: application/json schema",
        "POST /getCostEstimate.encryptedCardNumber: application/json schema",
        "POST /getCostEstimate.shopperReference: application/json schema"
      ]
    }
  }
```
...
```json
{
    ...
    "messages": {
      ...
      "Version follows semantic versioning": "Version \"54\" does not match semver format (expected MAJOR.MINOR.PATCH)"
    }
  }
```
