...
- **Status:** Failed
- **Message:** Documentation quality issues found: All request/response bodies have examples: POST /getTerminalsUnderAccount: request body, POST /getTerminalsUnderAccount: 401 application/json response, POST /assignTerminals: request body, POST /assignTerminals: 401 application/json response, POST /findTerminal: request body, POST /findTerminal: 401 application/json response, POST /getStoresUnderAccount: request body, POST /getStoresUnderAccount: 401 application/json response, POST /getTerminalDetails: request body, POST /getTerminalDetails: 401 application/json response; All schemas have descriptions: GetTerminalsUnderAccountResponse, Address, AssignTerminalsRequest, AssignTerminalsResponse, ServiceError, FindTerminalRequest, FindTerminalResponse, GetStoresUnderAccountRequest, GetTerminalsUnderAccountRequest, MerchantAccount, GetTerminalDetailsResponse, Store, GetStoresUnderAccountResponse, GetTerminalDetailsRequest
...
```json
{
    ...
    "missing_docs": {
      "All request/response bodies have examples": [
        "POST /getTerminalsUnderAccount: request body",
        "POST /getTerminalsUnderAccount: 401 application/json response",
        "POST /assignTerminals: request body",
        "POST /assignTerminals: 401 application/json response",
        "POST /findTerminal: request body",
        "POST /findTerminal: 401 application/json response",
        "POST /getStoresUnderAccount: request body",
        "POST /getStoresUnderAccount: 401 application/json response",
        "POST /getTerminalDetails: request body",
        "POST /getTerminalDetails: 401 application/json response"
      ],
      "All schemas have descriptions": [
...
- **Status:** Failed
- **Message:** Request validation issues found: All string fields have length constraints: POST /getStoresUnderAccount.companyAccount: application/json schema, POST /getStoresUnderAccount.merchantAccount: application/json schema, POST /getTerminalDetails.terminal: application/json schema, POST /getTerminalsUnderAccount.companyAccount: application/json schema, POST /getTerminalsUnderAccount.merchantAccount: application/json schema, POST /getTerminalsUnderAccount.store: application/json schema, POST /assignTerminals.terminals[]: application/json schema, POST /assignTerminals.companyAccount: application/json schema, POST /assignTerminals.merchantAccount: application/json schema, POST /assignTerminals.store: application/json schema, POST /findTerminal.terminal: application/json schema
...
```json
{
    ...
    "missing_validation": {
      "All string fields have length constraints": [
        "POST /getStoresUnderAccount.companyAccount: application/json schema",
        "POST /getStoresUnderAccount.merchantAccount: application/json schema",
        "POST /getTerminalDetails.terminal: application/json schema",
        "POST /getTerminalsUnderAccount.companyAccount: application/json schema",
        "POST /getTerminalsUnderAccount.merchantAccount: application/json schema",
        "POST /getTerminalsUnderAccount.store: application/json schema",
        "POST /assignTerminals.terminals[]: application/json schema",
        "POST /assignTerminals.companyAccount: application/json schema",
        "POST /assignTerminals.merchantAccount: application/json schema",
        "POST /assignTerminals.store: application/json schema",
        "POST /findTerminal.terminal: application/json schema"
      ]
    }
  }
```
