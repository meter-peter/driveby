...
- **Status:** Failed
- **Message:** OpenAPI spec validation failed: Specification structure is valid: invalid paths: invalid path /analytics/itinerary-price-metrics: invalid operation GET: parameter "oneWay" schema is invalid: invalid default: value must be a boolean
Schema:
  {
    "default": "false",
    "type": "boolean"
...
```json
{
    ...
    "messages": {
      "Specification structure is valid": "invalid paths: invalid path /analytics/itinerary-price-metrics: invalid operation GET: parameter \"oneWay\" schema is invalid: invalid default: value must be a boolean\nSchema:\n  {\n    \"default\": \"false\",\n    \"type\": \"boolean\"\n  }\n\nValue:\n  \"false\"\n"
    }
  }
```
...
- **Status:** Failed
- **Message:** Documentation quality issues found: All operations have detailed descriptions: GET /analytics/itinerary-price-metrics
...
- **Status:** Failed
- **Message:** Request validation issues found: All string fields have length constraints: GET /analytics/itinerary-price-metrics: parameter departureDate
...
```json
{
    ...
    "missing_validation": {
      "All string fields have length constraints": [
        "GET /analytics/itinerary-price-metrics: parameter departureDate"
      ]
    }
  }
```
...
- **Status:** Failed
- **Message:** Error handling issues found: Error responses include error details schema: GET /analytics/itinerary-price-metrics: 400 response, GET /analytics/itinerary-price-metrics: 500 response
...
```json
{
    ...
    "missing_errors": {
      "Error responses include error details schema": [
        "GET /analytics/itinerary-price-metrics: 400 response",
        "GET /analytics/itinerary-price-metrics: 500 response"
      ]
    }
  }
```
...
- **Status:** Failed
- **Message:** Security validation failed: Security schemes are defined: No security schemes defined in components.securitySchemes; Global security requirements are set: No top-level security requirements defined; Operation-level security is defined: Endpoints without security: GET /analytics/itinerary-price-metrics
...
```json
{
    ...
    "messages": {
      ...
      "Operation-level security is defined": "Endpoints without security: GET /analytics/itinerary-price-metrics",
