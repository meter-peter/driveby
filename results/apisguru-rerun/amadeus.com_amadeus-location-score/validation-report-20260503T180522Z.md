...
- **Status:** Failed
- **Message:** Documentation quality issues found: All operations have detailed descriptions: GET /location/analytics/category-rated-areas; All schemas have descriptions: category-rated-areas
...
- **Status:** Failed
- **Message:** Request validation issues found: All numeric fields have min/max values: GET /location/analytics/category-rated-areas: parameter latitude, GET /location/analytics/category-rated-areas: parameter longitude
...
```json
{
    ...
    "missing_validation": {
      "All numeric fields have min/max values": [
        "GET /location/analytics/category-rated-areas: parameter latitude",
        "GET /location/analytics/category-rated-areas: parameter longitude"
      ]
    }
  }
```
...
- **Status:** Failed
- **Message:** Error handling issues found: Error responses include error details schema: GET /location/analytics/category-rated-areas: 400 response, GET /location/analytics/category-rated-areas: 500 response
...
```json
{
    ...
    "missing_errors": {
      "Error responses include error details schema": [
        "GET /location/analytics/category-rated-areas: 400 response",
        "GET /location/analytics/category-rated-areas: 500 response"
      ]
    }
  }
```
...
- **Status:** Failed
- **Message:** Security validation failed: Operation-level security is defined: Endpoints without security: GET /location/analytics/category-rated-areas; Security schemes are defined: No security schemes defined in components.securitySchemes; Global security requirements are set: No top-level security requirements defined
...
```json
{
    ...
    "messages": {
      "Global security requirements are set": "No top-level security requirements defined",
      "Operation-level security is defined": "Endpoints without security: GET /location/analytics/category-rated-areas",
...
- **Status:** Failed
- **Message:** Versioning validation failed: Migration guides are referenced: Info description does not reference migration or upgrade guides; Versioning strategy is documented: Info description does not mention versioning strategy; Breaking changes are documented: Info description does not reference breaking changes or a changelog; Version compatibility is specified: Info description does not mention version compatibility
