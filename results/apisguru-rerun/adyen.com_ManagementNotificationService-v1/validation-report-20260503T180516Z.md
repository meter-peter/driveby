...
- **Status:** Failed
- **Message:** Documentation quality issues found: All schemas have descriptions: NotificationDataMessage-type2, NotificationDataMessage-type3, AccountUpdateNotificationData, RemediatingAction, CapabilityProblemEntity-recursive, AccountCapabilityData, MidServiceNotificationData, AccountNotificationResponse, CapabilityProblem, VerificationError, PaymentMethodNotificationResponse, VerificationError-recursive, NotificationDataMessage, AccountCreateNotificationData, CapabilityProblemEntity
