...
- **Status:** Failed
- **Message:** Documentation quality issues found: All schemas have descriptions: TransactionRulesResult, NameLocation, PaymentNotificationRequest, ResourceReference, TransactionEventViolation, TransactionRuleReference, Address, Counterparty, TransactionNotificationData, BalancePlatformNotificationResponse, Name, Resource, IncomingTransferNotificationData, NotificationModificationData, PlatformPayment, OutgoingTransferNotificationData, PaymentNotificationData, BankAccountInfo, RelayedAuthorisationData, IncomingTransferNotificationRequest, TransactionRuleSource, MerchantData, OutgoingTransferNotificationRequest, ValidationResult, Amount
