...
- **Status:** Failed
- **Message:** Documentation quality issues found: All schemas have descriptions: NameLocation, TransactionEventViolation, HULocalAccountIdentification, BalancePlatformNotificationResponse, PaymentInstrument, UKLocalAccountIdentification, USLocalAccountIdentification, TransferNotificationValidationFact, BalanceMutation, CounterpartyV3, TransferNotificationTransferTracking, Amount, TransferNotificationRequest, SGLocalAccountIdentification, TransferNotificationData, MerchantData, Address, BRLocalAccountIdentification, TransactionRuleSource, NumberAndBicAccountIdentification, DKLocalAccountIdentification, AmountAdjustment, BankAccountV3, TransactionRuleReference, Resource, ResourceReference, RelayedAuthorisationData, AULocalAccountIdentification, SELocalAccountIdentification, TransferEvent, CALocalAccountIdentification, PLLocalAccountIdentification, AdditionalBankIdentification, NOLocalAccountIdentification, CZLocalAccountIdentification, PartyIdentification, TransactionRulesResult, IbanAccountIdentification
