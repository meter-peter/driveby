...
- **Status:** Failed
- **Message:** Documentation quality issues found: All request/response bodies have examples: POST /requestSubjectErasure: request body, POST /requestSubjectErasure: application/json request body, POST /requestSubjectErasure: 500 application/json response, POST /requestSubjectErasure: 200 application/json response, POST /requestSubjectErasure: 400 application/json response, POST /requestSubjectErasure: 401 application/json response, POST /requestSubjectErasure: 403 application/json response, POST /requestSubjectErasure: 422 application/json response; All schemas have descriptions: ServiceError, SubjectErasureByPspReferenceRequest, SubjectErasureResponse
...
```json
{
    ...
    "missing_docs": {
      "All request/response bodies have examples": [
        "POST /requestSubjectErasure: request body",
        "POST /requestSubjectErasure: application/json request body",
        "POST /requestSubjectErasure: 500 application/json response",
        "POST /requestSubjectErasure: 200 application/json response",
        "POST /requestSubjectErasure: 400 application/json response",
        "POST /requestSubjectErasure: 401 application/json response",
        "POST /requestSubjectErasure: 403 application/json response",
        "POST /requestSubjectErasure: 422 application/json response"
      ],
      "All schemas have descriptions": [
        "ServiceError",
...
- **Status:** Failed
- **Message:** Request validation issues found: All string fields have length constraints: POST /requestSubjectErasure.merchantAccount: application/json schema, POST /requestSubjectErasure.pspReference: application/json schema
...
```json
{
    ...
    "missing_validation": {
      "All string fields have length constraints": [
        "POST /requestSubjectErasure.merchantAccount: application/json schema",
        "POST /requestSubjectErasure.pspReference: application/json schema"
      ]
    }
  }
```
