...
- **Status:** Failed
- **Message:** Documentation quality issues found: All request/response bodies have examples: POST /createTestCardRanges: request body, POST /createTestCardRanges: application/json request body, POST /createTestCardRanges: 200 application/json response, POST /createTestCardRanges: 400 application/json response, POST /createTestCardRanges: 401 application/json response, POST /createTestCardRanges: 403 application/json response, POST /createTestCardRanges: 422 application/json response, POST /createTestCardRanges: 500 application/json response; All schemas have descriptions: TestCardRangeCreationResult, AvsAddress, CreateTestCardRangesRequest, CreateTestCardRangesResult, ServiceError, TestCardRange
...
```json
{
    ...
    "missing_docs": {
      "All request/response bodies have examples": [
        "POST /createTestCardRanges: request body",
        "POST /createTestCardRanges: application/json request body",
        "POST /createTestCardRanges: 200 application/json response",
        "POST /createTestCardRanges: 400 application/json response",
        "POST /createTestCardRanges: 401 application/json response",
        "POST /createTestCardRanges: 403 application/json response",
        "POST /createTestCardRanges: 422 application/json response",
        "POST /createTestCardRanges: 500 application/json response"
      ],
      "All schemas have descriptions": [
...
- **Status:** Failed
- **Message:** Request validation issues found: All schemas specify data types: POST /createTestCardRanges: application/json schema, POST /createTestCardRanges.testCardRanges[]: application/json schema, POST /createTestCardRanges.testCardRanges[].address: application/json schema; All string fields have length constraints: POST /createTestCardRanges.accountCode: application/json schema, POST /createTestCardRanges.accountTypeCode: application/json schema, POST /createTestCardRanges.testCardRanges[].threeDDirectoryServerResponse: application/json schema, POST /createTestCardRanges.testCardRanges[].cardHolderName: application/json schema, POST /createTestCardRanges.testCardRanges[].expiryMonth: application/json schema, POST /createTestCardRanges.testCardRanges[].cvc: application/json schema, POST /createTestCardRanges.testCardRanges[].threeDUsername: application/json schema, POST /createTestCardRanges.testCardRanges[].address.zip: application/json schema, POST /createTestCardRanges.testCardRanges[].address.streetAddress: application/json schema, POST /createTestCardRanges.testCardRanges[].rangeStart: application/json schema, POST /createTestCardRanges.testCardRanges[].threeDPassword: application/json schema, POST /createTestCardRanges.testCardRanges[].rangeEnd: application/json schema; All numeric fields have min/max values: POST /createTestCardRanges.testCardRanges[].expiryYear: application/json schema
...
```json
{
    ...
    "missing_validation": {
      "All numeric fields have min/max values": [
        "POST /createTestCardRanges.testCardRanges[].expiryYear: application/json schema"
      ],
      "All schemas specify data types": [
        "POST /createTestCardRanges: application/json schema",
        "POST /createTestCardRanges.testCardRanges[]: application/json schema",
        "POST /createTestCardRanges.testCardRanges[].address: application/json schema"
      ],
      "All string fields have length constraints": [
        "POST /createTestCardRanges.accountCode: application/json schema",
        "POST /createTestCardRanges.accountTypeCode: application/json schema",
        "POST /createTestCardRanges.testCardRanges[].threeDDirectoryServerResponse: application/json schema",
        "POST /createTestCardRanges.testCardRanges[].cardHolderName: application/json schema",
        "POST /createTestCardRanges.testCardRanges[].expiryMonth: application/json schema",
        "POST /createTestCardRanges.testCardRanges[].cvc: application/json schema",
        "POST /createTestCardRanges.testCardRanges[].threeDUsername: application/json schema",
        "POST /createTestCardRanges.testCardRanges[].address.zip: application/json schema",
        "POST /createTestCardRanges.testCardRanges[].address.streetAddress: application/json schema",
        "POST /createTestCardRanges.testCardRanges[].rangeStart: application/json schema",
        "POST /createTestCardRanges.testCardRanges[].threeDPassword: application/json schema",
        "POST /createTestCardRanges.testCardRanges[].rangeEnd: application/json schema"
      ]
    }
  }
```
