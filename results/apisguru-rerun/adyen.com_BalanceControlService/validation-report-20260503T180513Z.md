...
- **Status:** Failed
- **Message:** Documentation quality issues found: All request/response bodies have examples: POST /balanceTransfer: request body; All schemas have descriptions: Amount, BalanceTransferRequest, BalanceTransferResponse
...
```json
{
    ...
    "missing_docs": {
      "All request/response bodies have examples": [
        "POST /balanceTransfer: request body"
      ],
      "All schemas have descriptions": [
        "Amount",
...
- **Status:** Failed
- **Message:** Request validation issues found: All numeric fields have min/max values: POST /balanceTransfer.amount.value: application/json schema; All string fields have length constraints: POST /balanceTransfer.fromMerchant: application/json schema, POST /balanceTransfer.toMerchant: application/json schema, POST /balanceTransfer.type: application/json schema
...
```json
{
    ...
    "missing_validation": {
      "All numeric fields have min/max values": [
        "POST /balanceTransfer.amount.value: application/json schema"
      ],
      "All string fields have length constraints": [
        "POST /balanceTransfer.fromMerchant: application/json schema",
        "POST /balanceTransfer.toMerchant: application/json schema",
        "POST /balanceTransfer.type: application/json schema"
      ]
    }
  }
```
...
- **Status:** Failed
- **Message:** Error handling issues found: All operations document 4xx error responses: POST /balanceTransfer; All operations document 5xx error responses: POST /balanceTransfer
