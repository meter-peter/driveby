...
- **Status:** Failed
- **Message:** Documentation quality issues found: All schemas have descriptions: AccountSupportingEntityCapability, CardOrderNotificationRequest, Name, BalancePlatformNotificationResponse, Card, Contact, AccountHolderNotificationRequest, Phone, CardOrderItemDeliveryStatus, Amount, JSONObject, SweepCounterparty, BalanceAccountNotificationRequest, AccountHolderCapability, Resource, PaymentInstrumentNotificationData, SweepConfigurationV2, SweepSchedule, CronSweepSchedule, PaymentNotificationRequest, PersonalData, SweepConfigurationNotificationRequest, IbanAccountIdentification, SweepConfiguration, Address, BalanceAccount, SweepConfigurationNotificationData, PhoneNumber, CardOrderItem, AccountHolder, BalanceAccountNotificationData, Expiry, Authentication, CardConfiguration, Balance, JSONPath, PaymentInstrument, PaymentInstrumentReference, AccountHolderNotificationData, ContactDetails, USLocalAccountIdentification, BulkAddress, CapabilityProblem
...
- **Status:** Failed
- **Message:** Versioning validation failed: Version follows semantic versioning: Version "1" does not match semver format (expected MAJOR.MINOR.PATCH); Versioning strategy is documented: Info description does not mention versioning strategy; Breaking changes are documented: Info description does not reference breaking changes or a changelog; Version compatibility is specified: Info description does not mention version compatibility; Migration guides are referenced: Info description does not reference migration or upgrade guides
