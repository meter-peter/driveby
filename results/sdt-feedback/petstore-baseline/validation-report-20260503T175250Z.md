...
Generated: 2026-05-03T20:52:50+03:00
...
- **Status:** Failed
- **Message:** Documentation quality issues found: All schemas have descriptions: User, ApiResponse, Category, Order, Pet, Tag; All request/response bodies have examples: GET /user/login: 200 application/xml response, GET /user/login: 200 application/json response, GET /pet/findByStatus: 200 application/json response, GET /pet/findByStatus: 200 application/xml response, GET /pet/findByTags: 200 application/json response, GET /pet/findByTags: 200 application/xml response, GET /user/{username}: 200 application/json response, GET /user/{username}: 200 application/xml response, PUT /user/{username}: application/xml request body, PUT /user/{username}: application/json request body, PUT /user/{username}: application/x-www-form-urlencoded request body, POST /pet: application/xml request body, POST /pet: application/json request body, POST /pet: application/x-www-form-urlencoded request body, POST /pet: 200 application/xml response, POST /pet: 200 application/json response, PUT /pet: application/json request body, PUT /pet: application/x-www-form-urlencoded request body, PUT /pet: application/xml request body, PUT /pet: 200 application/xml response, PUT /pet: 200 application/json response, GET /store/inventory: 200 application/json response, POST /user: application/xml request body, POST /user: application/json request body, POST /user: application/x-www-form-urlencoded request body, POST /user: 200 application/json response, POST /user: 200 application/xml response, POST /user/createWithList: request body, POST /user/createWithList: application/json request body, POST /user/createWithList: 200 application/xml response, POST /user/createWithList: 200 application/json response, POST /pet/{petId}: 200 application/json response, POST /pet/{petId}: 200 application/xml response, GET /pet/{petId}: 200 application/json response, GET /pet/{petId}: 200 application/xml response, POST /pet/{petId}/uploadImage: request body, POST /pet/{petId}/uploadImage: application/octet-stream request body, POST /pet/{petId}/uploadImage: 200 application/json response, POST /store/order: request body, POST /store/order: application/xml request body, POST /store/order: application/json request body, POST /store/order: application/x-www-form-urlencoded request body, POST /store/order: 200 application/json response, GET /store/order/{orderId}: 200 application/json response, GET /store/order/{orderId}: 200 application/xml response; All parameters have descriptions: DELETE /pet/{petId}: parameter api_key
...
- **Status:** Failed
- **Message:** Request validation issues found: All string fields have length constraints: POST /pet.photoUrls[]: application/json schema, POST /pet.status: application/json schema, POST /pet.tags[].name: application/json schema, POST /pet.category.name: application/json schema, POST /pet.name: application/json schema, POST /pet.status: application/x-www-form-urlencoded schema, POST /pet.tags[].name: application/x-www-form-urlencoded schema, POST /pet.category.name: application/x-www-form-urlencoded schema, POST /pet.name: application/x-www-form-urlencoded schema, POST /pet.photoUrls[]: application/x-www-form-urlencoded schema, POST /pet.category.name: application/xml schema, POST /pet.name: application/xml schema, POST /pet.photoUrls[]: application/xml schema, POST /pet.status: application/xml schema, POST /pet.tags[].name: application/xml schema, PUT /pet.photoUrls[]: application/x-www-form-urlencoded schema, PUT /pet.status: application/x-www-form-urlencoded schema, PUT /pet.tags[].name: application/x-www-form-urlencoded schema, PUT /pet.category.name: application/x-www-form-urlencoded schema, PUT /pet.name: application/x-www-form-urlencoded schema, PUT /pet.category.name: application/xml schema, PUT /pet.name: application/xml schema, PUT /pet.photoUrls[]: application/xml schema, PUT /pet.status: application/xml schema, PUT /pet.tags[].name: application/xml schema, PUT /pet.name: application/json schema, PUT /pet.photoUrls[]: application/json schema, PUT /pet.status: application/json schema, PUT /pet.tags[].name: application/json schema, PUT /pet.category.name: application/json schema, POST /user.username: application/x-www-form-urlencoded schema, POST /user.email: application/x-www-form-urlencoded schema, POST /user.firstName: application/x-www-form-urlencoded schema, POST /user.lastName: application/x-www-form-urlencoded schema, POST /user.password: application/x-www-form-urlencoded schema, POST /user.phone: application/x-www-form-urlencoded schema, POST /user.username: application/xml schema, POST /user.email: application/xml schema, POST /user.firstName: application/xml schema, POST /user.lastName: application/xml schema, POST /user.password: application/xml schema, POST /user.phone: application/xml schema, POST /user.password: application/json schema, POST /user.phone: application/json schema, POST /user.username: application/json schema, POST /user.email: application/json schema, POST /user.firstName: application/json schema, POST /user.lastName: application/json schema, GET /pet/findByStatus: parameter status, DELETE /pet/{petId}: parameter api_key, POST /pet/{petId}: parameter name, POST /pet/{petId}: parameter status, POST /pet/{petId}/uploadImage: parameter additionalMetadata, POST /pet/{petId}/uploadImage: application/octet-stream schema, POST /store/order.shipDate: application/json schema, POST /store/order.status: application/json schema, POST /store/order.shipDate: application/x-www-form-urlencoded schema, POST /store/order.status: application/x-www-form-urlencoded schema, POST /store/order.shipDate: application/xml schema, POST /store/order.status: application/xml schema, POST /user/createWithList[].password: application/json schema, POST /user/createWithList[].phone: application/json schema, POST /user/createWithList[].username: application/json schema, POST /user/createWithList[].email: application/json schema, POST /user/createWithList[].firstName: application/json schema, POST /user/createWithList[].lastName: application/json schema, GET /user/login: parameter username, GET /user/login: parameter password, PUT /user/{username}: parameter username, PUT /user/{username}.email: application/xml schema, PUT /user/{username}.firstName: application/xml schema, PUT /user/{username}.lastName: application/xml schema, PUT /user/{username}.password: application/xml schema, PUT /user/{username}.phone: application/xml schema, PUT /user/{username}.username: application/xml schema, PUT /user/{username}.firstName: application/json schema, PUT /user/{username}.lastName: application/json schema, PUT /user/{username}.password: application/json schema, PUT /user/{username}.phone: application/json schema, PUT /user/{username}.username: application/json schema, PUT /user/{username}.email: application/json schema, PUT /user/{username}.password: application/x-www-form-urlencoded schema, PUT /user/{username}.phone: application/x-www-form-urlencoded schema, PUT /user/{username}.username: application/x-www-form-urlencoded schema, PUT /user/{username}.email: application/x-www-form-urlencoded schema, PUT /user/{username}.firstName: application/x-www-form-urlencoded schema, PUT /user/{username}.lastName: application/x-www-form-urlencoded schema, DELETE /user/{username}: parameter username, GET /user/{username}: parameter username; All numeric fields have min/max values: POST /pet.tags[].id: application/json schema, POST /pet.category.id: application/json schema, POST /pet.id: application/json schema, POST /pet.tags[].id: application/x-www-form-urlencoded schema, POST /pet.category.id: application/x-www-form-urlencoded schema, POST /pet.id: application/x-www-form-urlencoded schema, POST /pet.category.id: application/xml schema, POST /pet.id: application/xml schema, POST /pet.tags[].id: application/xml schema, PUT /pet.tags[].id: application/x-www-form-urlencoded schema, PUT /pet.category.id: application/x-www-form-urlencoded schema, PUT /pet.id: application/x-www-form-urlencoded schema, PUT /pet.category.id: application/xml schema, PUT /pet.id: application/xml schema, PUT /pet.tags[].id: application/xml schema, PUT /pet.tags[].id: application/json schema, PUT /pet.category.id: application/json schema, PUT /pet.id: application/json schema, DELETE /store/order/{orderId}: parameter orderId, GET /store/order/{orderId}: parameter orderId, POST /user.id: application/x-www-form-urlencoded schema, POST /user.userStatus: application/x-www-form-urlencoded schema, POST /user.userStatus: application/xml schema, POST /user.id: application/xml schema, POST /user.userStatus: application/json schema, POST /user.id: application/json schema, DELETE /pet/{petId}: parameter petId, GET /pet/{petId}: parameter petId, POST /pet/{petId}: parameter petId, POST /pet/{petId}/uploadImage: parameter petId, POST /store/order.id: application/json schema, POST /store/order.petId: application/json schema, POST /store/order.quantity: application/json schema, POST /store/order.id: application/x-www-form-urlencoded schema, POST /store/order.petId: application/x-www-form-urlencoded schema, POST /store/order.quantity: application/x-www-form-urlencoded schema, POST /store/order.id: application/xml schema, POST /store/order.petId: application/xml schema, POST /store/order.quantity: application/xml schema, POST /user/createWithList[].userStatus: application/json schema, POST /user/createWithList[].id: application/json schema, PUT /user/{username}.id: application/xml schema, PUT /user/{username}.userStatus: application/xml schema, PUT /user/{username}.id: application/json schema, PUT /user/{username}.userStatus: application/json schema, PUT /user/{username}.userStatus: application/x-www-form-urlencoded schema, PUT /user/{username}.id: application/x-www-form-urlencoded schema
...
- **Status:** Failed
- **Message:** Error handling issues found: All operations document 4xx error responses: POST /user/createWithList, POST /user, GET /user/logout, GET /store/inventory; All operations document 5xx error responses: DELETE /store/order/{orderId}, GET /store/order/{orderId}, POST /user/createWithList, GET /user/login, GET /pet/findByStatus, GET /pet/findByTags, POST /pet/{petId}/uploadImage, PUT /user/{username}, DELETE /user/{username}, GET /user/{username}, POST /pet, PUT /pet, POST /user, GET /user/logout, DELETE /pet/{petId}, GET /pet/{petId}, POST /pet/{petId}, GET /store/inventory, POST /store/order; Error responses include error details schema: DELETE /store/order/{orderId}: 400 response, DELETE /store/order/{orderId}: 404 response, GET /store/order/{orderId}: 400 response, GET /store/order/{orderId}: 404 response, GET /user/login: 400 response, GET /pet/findByStatus: 400 response, GET /pet/findByTags: 400 response, POST /pet/{petId}/uploadImage: 400 response, POST /pet/{petId}/uploadImage: 404 response, PUT /user/{username}: 400 response, PUT /user/{username}: 404 response, DELETE /user/{username}: 400 response, DELETE /user/{username}: 404 response, GET /user/{username}: 400 response, GET /user/{username}: 404 response, POST /pet: 400 response, POST /pet: 422 response, PUT /pet: 400 response, PUT /pet: 404 response, PUT /pet: 422 response, DELETE /pet/{petId}: 400 response, GET /pet/{petId}: 400 response, GET /pet/{petId}: 404 response, POST /pet/{petId}: 400 response, POST /store/order: 400 response, POST /store/order: 422 response
...
- **Status:** Failed
- **Message:** Security validation failed: API keys are properly described: apiKey schemes missing description: api_key; Global security requirements are set: No top-level security requirements defined; Operation-level security is defined: Endpoints without security: POST /user/createWithList, GET /user/login, DELETE /store/order/{orderId}, GET /store/order/{orderId}, GET /user/logout, GET /user/{username}, PUT /user/{username}, DELETE /user/{username}, POST /store/order, POST /user
...
```json
{
    ...
    "messages": {
      ...
      "Operation-level security is defined": "Endpoints without security: POST /user/createWithList, GET /user/login, DELETE /store/order/{orderId}, GET /store/order/{orderId}, GET /user/logout, GET /user/{username}, PUT /user/{username}, DELETE /user/{username}, POST /store/order, POST /user"
    }
  }
```
