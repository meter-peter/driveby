...
- **Status:** Failed
- **Message:** Request validation issues found: All schemas specify data types: POST /products: application/json schema, PUT /products/{product_id}: application/json schema, POST /tasks: application/json schema, POST /test/echo: application/json schema
...
```json
{
    ...
    "missing_validation": {
      "All schemas specify data types": [
        "POST /products: application/json schema",
        "PUT /products/{product_id}: application/json schema",
        "POST /tasks: application/json schema",
        "POST /test/echo: application/json schema"
      ]
    }
  }
```
