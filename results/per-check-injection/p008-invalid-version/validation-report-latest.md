...
- **Status:** Failed
- **Message:** Versioning validation failed: Version follows semantic versioning: Version "latest" does not match semver format (expected MAJOR.MINOR.PATCH)
...
```json
{
    ...
    "messages": {
      "Version follows semantic versioning": "Version \"latest\" does not match semver format (expected MAJOR.MINOR.PATCH)"
    }
  }
```
