...
- **Status:** Failed
- **Message:** OpenAPI spec validation failed: Specification structure is valid: invalid paths: invalid path /products: extra sibling fields: [FOO]
...
```json
{
    ...
    "messages": {
      "Specification structure is valid": "invalid paths: invalid path /products: extra sibling fields: [FOO]"
    }
  }
```
...
- **Status:** Failed
- **Message:** Documentation quality issues found: All request/response bodies have examples: POST /test/echo: application/json request body, POST /test/echo: 500 application/json response, POST /test/echo: 200 application/json response, POST /test/echo: 401 application/json response, POST /test/echo: 422 application/json response, GET /test/health: 200 application/json response, GET /test/health: 400 application/json response, GET /test/health: 404 application/json response, GET /test/health: 500 application/json response, GET /legacy/products: 200 application/json response, GET /legacy/products: 401 application/json response, GET /legacy/products: 500 application/json response, POST /products: application/json request body, POST /products: 401 application/json response, POST /products: 422 application/json response, POST /products: 500 application/json response, POST /products: 201 application/json response, DELETE /products/{product_id}: 401 application/json response, DELETE /products/{product_id}: 404 application/json response, DELETE /products/{product_id}: 422 application/json response, DELETE /products/{product_id}: 500 application/json response, GET /products/{product_id}: 500 application/json response, GET /products/{product_id}: 200 application/json response, GET /products/{product_id}: 401 application/json response, GET /products/{product_id}: 404 application/json response, GET /products/{product_id}: 422 application/json response, PUT /products/{product_id}: application/json request body, PUT /products/{product_id}: 200 application/json response, PUT /products/{product_id}: 401 application/json response, PUT /products/{product_id}: 404 application/json response, PUT /products/{product_id}: 422 application/json response, PUT /products/{product_id}: 500 application/json response, POST /tasks: application/json request body, POST /tasks: 400 application/json response, POST /tasks: 401 application/json response, POST /tasks: 422 application/json response, POST /tasks: 500 application/json response, POST /tasks: 201 application/json response
