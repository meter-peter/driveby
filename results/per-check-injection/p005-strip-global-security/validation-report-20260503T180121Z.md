...
- **Status:** Failed
- **Message:** Security validation failed: Operation-level security is defined: Endpoints without security: GET /test/health; Global security requirements are set: No top-level security requirements defined
...
```json
{
    ...
    "messages": {
      ...
      "Operation-level security is defined": "Endpoints without security: GET /test/health"
    }
  }
```
